...
impl Index<TrapFrameArgs> for TrapFrame {
    ...
    fn index(&self, index: TrapFrameArgs) -> &Self::Output {
        match index {
            ...
            TrapFrameArgs::ARG3 => &self.rcx,
            TrapFrameArgs::ARG4 => &self.r8,
            TrapFrameArgs::ARG5 => &self.r9,
...
impl IndexMut<TrapFrameArgs> for TrapFrame {
    fn index_mut(&mut self, index: TrapFrameArgs) -> &mut Self::Output {
        match index {
            ...
            TrapFrameArgs::ARG3 => &mut self.rcx,
            TrapFrameArgs::ARG4 => &mut self.r8,
            TrapFrameArgs::ARG5 => &mut self.r9,
